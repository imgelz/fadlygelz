        ...
        <nav class="main-menu">
            <ul class="nav metismenu">
                <li class="nav-dropdown">
                    <a class="has-arrow" href="{{route('artikel.index')}}" aria-expanded="false"><i class="icon dripicons-browser"></i><span>Artikel</span></a>
                </li>
                <li class="nav-dropdown">
                        <a class="has-arrow" href="{{route('tag.index')}}" aria-expanded="false"><i class="icon dripicons-browser"></i><span>Tag</span></a>
                </li>
                <li class="nav-dropdown">
                    <a class="has-arrow" href="{{route('kategori.index')}}" aria-expanded="false"><i class="icon dripicons-browser"></i><span>Kategori</span></a>
            </li>
                </ul>
            </nav>
        </div>
