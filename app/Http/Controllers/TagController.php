...
class TagController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash("flash_notification", ["level"=>"success",
                                              "message"=>"Berhasil menyimpan data<b>".$tag->nama_tag."</b>"]);
    ...
    {
        $request->validate(['nama_tag'=>'required']);
        ...
        Session::flash("flash_notification", ["level"=>"warning",
                                              "message"=>"Berhasil mengedit data <b>".$tag->nama_tag."</b>"]);
    ...
    public function destroy($id)
    {
        ...
        Session::flash("flash_notification", ["level"=>"danger",
                                              "message"=>"Berhasil menghapus data <b>".$tag->nama_tag."</b>"]);
        return redirect()->route('tag.index');
    }
}
